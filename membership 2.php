<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $select = mysqli_query($root, "SELECT * FROM premium_membership WHERE 
        ...
        if(mysqli_num_rows($select) > 0){
            ...
            mysqli_query($root, "INSERT INTO premium_membership 
                        (card_number, 
                        expiration_date,
                        cvv,
                        card_holder,
        ...
        header("location: home.php?subscriptionExpired1=true");
...
<html lang="en">
<head>
    <link rel="stylesheet" href="css/payment2css.css">
    <meta charset="UTF-8">
