<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $select = mysqli_query($root, "SELECT * FROM basic_membership WHERE 
        ...
        if(mysqli_num_rows($select) > 0){
            ...
            mysqli_query($root, "INSERT INTO basic_membership 
                        (card_number, 
                        expiration_date,
                        cvv,
                        card_holder,
        ...
        header("location: home.php?subscriptionExpired=true");
...
<html lang="en">
<head>
    <link rel="stylesheet" href="css/payment1css.css">
    <meta charset="UTF-8">
